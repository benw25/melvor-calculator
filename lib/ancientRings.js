...
const calcAR8Hours = (averageTime, specialChance) => {
  const iterations = _.divide(HOUR_IN_SECONDS, averageTime) * 8;
...
const calcAllARs = (averageTime, specialChance) => {
  ...
  const chance8Hours = calcAR8Hours(averageTime, specialChance);
...
export const logAllARs = (ARTimes) => {
  ...
  console.log(`Chance 8H: \t${chance8Hours} %`);
